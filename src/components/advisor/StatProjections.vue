...
import type { ProjectedImprovements, StatRating } from '@/services/claudeAnalysis'
  ...
  <div class="stat-projections">
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        ...
        <div class="stat-current">{{ formatNumber(currentStats.damage) }}</div>
        <div class="stat-arrow">↑</div>
        <div class="stat-multiplier">~{{ projections.damage.estimatedMultiplier }}</div>
      ...
      <div class="stat-card">
        ...
        <div class="stat-current">{{ formatNumber(currentStats.toughness) }}</div>
        <div class="stat-arrow">↑</div>
        <div class="stat-multiplier">~{{ projections.toughness.estimatedMultiplier }}</div>
      ...
      <div class="stat-card">
        ...
        <div class="stat-current">{{ formatNumber(currentStats.recovery) }}</div>
        <div class="stat-arrow">↑</div>
        <div class="stat-multiplier">~{{ projections.recovery.estimatedMultiplier }}</div>
      ...
      <div class="stat-card">
        ...
        <div class="stat-current">{{ formatNumber(currentStats.life) }}</div>
        <div class="stat-arrow">↑</div>
        <div class="stat-multiplier">~{{ projections.life.estimatedMultiplier }}</div>
